    ...
    return (
        <div className="putovanje-form-container">
            ...
            <form className="putovanje-form" onSubmit={handleSubmit}>
                ...
                <input value={mjestoPolaska} name="mjestoPolaska" onChange={(e) => setMjestoPolaska(e.target.value)} id="mjestoPolaska" />
                <label htmlFor="mjestoDolaska">Unesite mjesto dolaska</label>
                <input value={mjestoDolaska} name="mjestoDolaska" onChange={(e) => setMjestoDolaska(e.target.value)} id="mjestoDolaska" />
                <label htmlFor="vrstaVozila">Odaberite vrstu vozila</label>
                <select value={vrstaVozila} onChange={(e) => setVrstaVozila(e.target.value)} id="vrstaVozila" name="vrstaVozila">
                ...
                <input value={datumPutovanja} onChange={(e) => setDatumPutovanja(e.target.value)} type="date" id="datumPutovanja" name="datumPutovanja" />
                <button className="gumb" type="submit">Izračunaj trošak</button>
            </form>
            <div>
                <label htmlFor="trosak">Trošak puta:</label>
                <input value={trosak} readOnly id="trosak" name="trosak" />
            </div>
        </div>
    )
}